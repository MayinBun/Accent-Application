...
<jsp:include page="../pageHeader.jsp">
	<jsp:param name="titel" value="Admin Beheer" />
</jsp:include>        
...
<%List<User> allUsers = Dao.INSTANCE.getAlleAdmins();%>
...
<form style="display:inline" action="AdminVerwijderenServlet.do?id=<%=ci.getId()%>" method="post">
...
<img src="../images/new.png" height="25px" width="25px" style="cursor: pointer; cursor: hand;" id="img" class="img"> Nieuwe Administrator toevoegen
<div id="popup_box">
	<div id="popcontainer">
		<div id="inputbox">
			<h3>Nieuwe admin toevoegen</h3>
			<form style="display:inline" action="AdminToevoegenServlet.do" method="post" onsubmit="setTimeout('location.reload());">
